...
8. **projectTitleDescriptionCheck**: Verify that the project titles and their descriptions match contextually. If a project title, such as "Movie Recommendation System," is given, the description should be aligned with the concept of a movie recommendation system. Flag any inconsistencies and provide a brief explanation.
9. **score**: Provide a score between 0 and 100 that evaluates how well the resume aligns with the JD. Consider the following factors in scoring:
