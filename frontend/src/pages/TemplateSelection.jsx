...
const TemplateSelection = () => {
  ...
  return (
    <div className=" bg-gray-100 dark:bg-gray-900 flex flex-col items-center w-screen " >
      {/* Navbar */}
      <nav className="bg-white dark:bg-gray-800 text-purple-900 dark:text-purple-400 w-full p-4 shadow-lg flex justify-between items-center">
        <div className="text-3xl font-extrabold tracking-wide text-gray-800 dark:text-white">GLA Resume Fit</div>
